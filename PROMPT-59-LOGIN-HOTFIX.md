...
Two issues blocking the owner from logging into CreateQuote:
...
**2. Login intermittently returns "invalid email or password" for valid credentials**
...
**In scope:**
- `frontend/js/auth.js` — show/hide toggle on password fields
...
### Chunk 1: Show/hide password toggle
